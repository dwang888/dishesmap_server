...
public class FourSquareInfoProcessor4Cache extends DataSourceProcessor{
	...
	public  FourSquareInfoProcessor4Cache(String configFile, GoodFoodFinder finder) throws Exception{
	...
	@Deprecated
	public  FourSquareInfoProcessor4Cache(String configFile) throws Exception{
		config = new Configuration(configFile);
		this.numBusiness = Integer.parseInt(config.getValue("numBusiness_FourSquare"));
		this.apiPrefixPlace = config.getValue("apiPrefixPlace_FourSquare");
		this.apiPrefixReview = config.getValue("apiPrefixReview_FourSquare");
...
//			close(conn);
	...
	public static void setNumBusiness(int numBusiness) {
		FourSquareInfoProcessor4Cache.numBusiness = numBusiness;
	}
	...
	public static void main(String[] args){
		...
		FourSquareInfoProcessor4Cache processor = null;
		try {
			processor = new FourSquareInfoProcessor4Cache(args[0]);
		} catch (Exception e) {
			e.printStackTrace();
		}
